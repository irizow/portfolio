...
export default function ActionPanda({isEating, setIsEating, isSleeping, setIsSleeping, isPlaying, setIsPlaying}: ActionPandaProps) {
    const frameWidth = 64; 
...
useEffect(() => {
  ...
  return () => clearTimeout(timer);
    ...
    >
        <SpriteAnimator
            sprite={isEating ? eatingPanda : isSleeping ? sleepingPanda : playingPanda}
            width={frameWidth}
            height={frameHeight}
            frameCount={16}
            fps={6}
