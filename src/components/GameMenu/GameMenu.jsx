...
export default function GameMenu({ darkTheme }) {
  return (
    <div
      className={
        darkTheme
          ? `${styles.gamemenu} ${styles.light}`
          : `${styles.gamemenu} ${styles.dark}`
      }
    >
      <a
        href="https://irizow.github.io/etch-a-sketch/"
        target="_blank"
      ...
      <a
        href="https://irizow.github.io/Tic-tac-toe/"
        target="_blank"
        rel="noopener noreferrer"
      >
        <div className={styles.gamecontainer}>
      ...
      <a
        href="https://pokemon-memory-vert.vercel.app/"
        target="_blank"
        rel="noopener noreferrer"
      >
        <div className={styles.gamecontainer}>
